...
class ColorPos:
    ...
    def edge(self, cub, colorOne, colorTwo):
...
#----------------------------------------------------------------------------------#
    ...
    def corner(self, cub, colorOne, colorTwo, colorThree):
...
#---------------------------------------------------------------------------------------------------------------#
    ...
    def checkPositionColor(self, cubOrigin, cubCurrent, colorOne, colorTwo, colorThree="null"):
        if (colorThree == "null"):
            listPositionCubCurrent = self.edge(cubCurrent, colorOne, colorTwo)
            listPositionCubOrigin = self.edge(cubOrigin, colorOne, colorTwo)
#             print("yo")
#             print(colorOne)
#             print(colorTwo)
